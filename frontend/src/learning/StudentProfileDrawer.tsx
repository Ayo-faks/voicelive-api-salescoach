...
const useStyles = makeStyles({
  ...
  drawerHeader: {
    ...
    background: `linear-gradient(180deg, var(--pf-surface), var(--pf-surface-muted))`,
  },
  drawerHeaderTitle: {
            ...
            <div className={styles.insightCard}>
              {voiceFluency?.status === 'available' ? (
                ...
                <>
                  ...
                  <span className={styles.evidenceItem}>
                    {voiceFluency?.evidence ??
                      'Wulo Academy has not received an oral-reading fluency sample for this student yet.'}
                  </span>
                </>
              )}
            </div>
