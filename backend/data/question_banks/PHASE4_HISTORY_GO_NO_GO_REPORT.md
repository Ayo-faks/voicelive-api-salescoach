...
safeguarding review) and authorized making the History bank learner-available.

What changed as a result:

- **Served diagnostic** (291 machine_verified items) is now learner-visible
...
- **34 flagged_for_human items remain pending** — held out of the served pack,
